...
namespace Goulash.Core.Tests.Services
{
    public class PackageDeletionServiceTests
    {
        ...
        private readonly GoulashOptions _options;
        ...
        public PackageDeletionServiceTests()
        {
            ...
            _options = new GoulashOptions();

            var optionsSnapshot = new Mock<IOptionsSnapshot<GoulashOptions>>();
