...
namespace Goulash.Core.Tests.Metadata;

public class ModelTests
{
    /// <summary>
    /// Goulash extends the NuGet protocol to add more functionality.
    ...
    /// "Goulash.Protocol" project. These tests ensure that the duplicates
    ...
    public static IEnumerable<object[]> ExtendedModelsData()
    {
        yield return new object[]
        {
            new ExtendedModelData
            {
                ...
                DerivedType = typeof(GoulashRegistrationIndexResponse),
                ...
                {
                    {
                        ...
                        (
                            ...
                            To: typeof(IReadOnlyList<GoulashRegistrationIndexPage>)
                        )
                    },
                }
            }
        ...
        yield return new object[]
        {
            new ExtendedModelData
            {
                ...
                DerivedType = typeof(GoulashRegistrationIndexPage),
                ...
                {
                    {
                        ...
                        (
                            ...
                            To: typeof(IReadOnlyList<GoulashRegistrationIndexPageItem>)
                        )
                    },
                }
            }
        ...
        yield return new object[]
        {
            new ExtendedModelData
            {
                ...
                DerivedType = typeof(GoulashRegistrationIndexPageItem),

                ModifiedProperties = new Dictionary<string, (Type From, Type To)>
                {
                    {
                        "PackageMetadata", ( From: typeof(PackageMetadata), To: typeof(GoulashPackageMetadata) )
                    },
                }
            }
        };
        ...
        yield return new object[]
        {
            new ExtendedModelData
            {
                ...
                DerivedType = typeof(GoulashPackageMetadata),
    ...
    {
        /// <summary>
        /// The model's type in the "Goulash.Protocol" project that was extended.
        /// </summary>
        public Type OriginalType { get; set; }

        /// <summary>
        /// The model's type in the "Goulash.Core" project that extends a
        /// type from the "Goulash.Protocol" project.
        /// </summary>
        public Type DerivedType { get; set; }

        /// <summary>
        /// The properties added by the model type in the "Goulash.Core" project.
        /// </summary>
