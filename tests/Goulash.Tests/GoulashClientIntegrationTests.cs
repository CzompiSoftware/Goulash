...
{
    /// <summary>
    /// Uses Goulash's client SDK to interact with the Goulash test host.
    /// </summary>
    public class GoulashClientIntegrationTests : IDisposable
    {
        private readonly GoulashApplication _app;
        ...
        public GoulashClientIntegrationTests(ITestOutputHelper output)
        {
            _app = new GoulashApplication(output);
