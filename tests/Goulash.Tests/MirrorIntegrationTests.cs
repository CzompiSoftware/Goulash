...
namespace Goulash.Tests
{
    ...
    {
        private readonly GoulashApplication _upstream;
        private readonly GoulashApplication _downstream;
        ...
        {
            _upstream = new GoulashApplication(output);
            _downstream = new GoulashApplication(output, _upstream.CreateClient());
