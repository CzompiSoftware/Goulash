...
namespace Goulash.Tests
{
    public class GoulashApplication : WebApplicationFactory<Startup>
    {
        private readonly ITestOutputHelper _output;
        private readonly HttpClient _upstreamClient;

        public GoulashApplication(ITestOutputHelper output, HttpClient upstreamClient = null)
        {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            var sqlitePath = Path.Combine(tempPath, "Goulash.db");
            ...
            builder
                ...
                {
                    // Goulash uses console logging by default. This logger throws operation
    ...
    internal static class GoulashWebApplicationFactoryExtensions
    {
