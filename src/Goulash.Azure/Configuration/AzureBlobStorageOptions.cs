...
{
    /// <summary>
    /// Goulash's configurations to use Azure Blob Storage to store packages.
    /// See: https://loic-sharma.github.io/Goulash/quickstart/azure/#azure-blob-storage
    /// </summary>
    public class AzureBlobStorageOptions : IValidatableObject
    {
        ...
        {
            const string helpUrl = "https://loic-sharma.github.io/Goulash/quickstart/azure/#azure-blob-storage";
