...
{
    /// <summary>
    /// Validates Goulash's options, used at startup.
    /// </summary>
    public class ValidateStartupOptions
    {
        private readonly IOptions<GoulashOptions> _root;
        ...
        public bool Validate()
        {
            ...
            catch (OptionsValidationException e)
            {
                ...
                _logger.LogError(e, "Goulash configuration is invalid.");
                return false;
            }
        }
    }
