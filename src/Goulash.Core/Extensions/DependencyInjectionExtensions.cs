...
{
    public static IServiceCollection AddGoulashApplication(
        this IServiceCollection services,
        Action<GoulashApplication> configureAction)
    {
        var app = new GoulashApplication(services);

        services.AddConfiguration();
        services.AddGoulashServices();
    ...
    public static IServiceCollection AddGoulashOptions<TOptions>(
        this IServiceCollection services,
        string key = null)
        where TOptions : class
    {
        services.AddSingleton<IValidateOptions<TOptions>>(new ValidateGoulashOptions<TOptions>(key));
    ...
    {
        services.AddGoulashOptions<GoulashOptions>();
        services.AddGoulashOptions<DatabaseOptions>(nameof(GoulashOptions.Database));
        services.AddGoulashOptions<FileSystemStorageOptions>(nameof(GoulashOptions.Storage));
        services.AddGoulashOptions<MirrorOptions>(nameof(GoulashOptions.Mirror));
        services.AddGoulashOptions<SearchOptions>(nameof(GoulashOptions.Search));
        services.AddGoulashOptions<StorageOptions>(nameof(GoulashOptions.Storage));
    }

    private static void AddGoulashServices(this IServiceCollection services)
    {
        ...
        services.TryAddTransient<IServiceIndexService, GoulashServiceIndex>();
    ...
    private static void AddFallbackServices(this IServiceCollection services)
    {
        ...
        // Goulash's services have multiple implementations that live side-by-side.
        ...
        //    container. This is the strategy used by applications that embed Goulash.
        ...
        //    by the default Goulash application.
        //
        // Goulash has database and search services, but the database services are special
