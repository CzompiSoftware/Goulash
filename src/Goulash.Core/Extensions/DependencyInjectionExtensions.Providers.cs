...
namespace Goulash.Core
{
    ...
    {
        private static readonly string DatabaseTypeKey = $"{nameof(GoulashOptions.Database)}:{nameof(DatabaseOptions.Type)}";
        private static readonly string SearchTypeKey = $"{nameof(GoulashOptions.Search)}:{nameof(SearchOptions.Type)}";
        private static readonly string StorageTypeKey = $"{nameof(GoulashOptions.Storage)}:{nameof(StorageOptions.Type)}";
        ...
        public static IServiceCollection AddGoulashDbContextProvider<TContext>(
            this IServiceCollection services,
            string databaseType,
