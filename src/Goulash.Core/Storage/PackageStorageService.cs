...
public class PackageStorageService : IPackageStorageService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        catch (DirectoryNotFoundException)
        {
            ...
            // users migrate to the latest version of Goulash.
            // See https://github.com/loic-sharma/Goulash/issues/298
            _logger.LogError(
                $"Unable to find the '{PackagesPathPrefix}' folder. " +
                "If you've recently upgraded Goulash, please make sure this folder starts with a lowercased letter. " +
                "For more information, please see https://github.com/loic-sharma/Goulash/issues/298");
            throw;
        }
    }
