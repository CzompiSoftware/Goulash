...
namespace Goulash.Core
{
    public class RegistrationBuilder
    {
        ...
        public virtual GoulashRegistrationIndexResponse BuildIndex(PackageRegistration registration)
        {
            ...
            return new GoulashRegistrationIndexResponse
            {
                ...
                Pages = new[]
                {
                    new GoulashRegistrationIndexPage
                    {
        ...
        private GoulashRegistrationIndexPageItem ToRegistrationIndexPageItem(Package package) =>
            new GoulashRegistrationIndexPageItem
            {
                ...
                PackageMetadata = new GoulashPackageMetadata
                {
