...
namespace Goulash
{
    ...
    {
        public static GoulashApplication AddAwsS3Storage(this GoulashApplication app)
        {
            app.Services.AddGoulashOptions<S3StorageOptions>(nameof(GoulashOptions.Storage));
        ...
        public static GoulashApplication AddAwsS3Storage(this GoulashApplication app, Action<S3StorageOptions> configure)
        {
            app.AddAwsS3Storage();
