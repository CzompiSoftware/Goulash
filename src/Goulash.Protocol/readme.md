...
[![Build Status](https://sharml.visualstudio.com/Goulash/_apis/build/status/loic-sharma.Goulash)](https://sharml.visualstudio.com/Goulash/_build/latest?definitionId=2) [![Join the chat at https://gitter.im/GoulashServer/community](https://badges.gitter.im/GoulashServer/community.svg)](https://gitter.im/GoulashServer/community?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge) [![Nuget](https://img.shields.io/nuget/dt/Goulash.Protocol)](https://www.nuget.org/packages/Goulash.Protocol)

Goulash's SDK to interact with the [NuGet protocol](https://docs.microsoft.com/en-us/nuget/api/overview).

[Package (NuGet)](https://www.nuget.org/packages/Goulash.Protocol) | [Documentation](https://loic-sharma.github.io/Goulash/advanced/sdk/) | [Samples](https://github.com/loic-sharma/Goulash/tree/master/samples)
